...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private void gameOver() {
		...
		String[] options = { "Yes", "No", "Maybe So"};
		int input = JOptionPane.showOptionDialog(null, "Do you wanna play again?", "", 0, -1, null, options, 0);
		...
		if(input == 2) {
			JOptionPane.showMessageDialog(null, "You're indecisive");
		}
